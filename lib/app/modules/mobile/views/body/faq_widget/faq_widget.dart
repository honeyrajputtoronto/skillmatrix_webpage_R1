...
class _FaqWidgetState extends State<FaqWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        key: itemKey4,
        padding: EdgeInsets.only(top: 20.0, left: 4.w ,right: 4.w , bottom: 10.w),
        child: Column(
          ...
          children: [
            GradientText(
              ...
              style: TextStyle(
                  fontSize: 7.w, fontWeight: FontWeight.bold),
            ...
            ExpansionTile(
              ...
              children: [
                Padding(
                  padding: EdgeInsets.symmetric(vertical:10.0,horizontal: 6.w),
                  child: Text(
